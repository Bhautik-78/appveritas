    ...
    return (
        <>
            <div className="dimo">
                ...
                <div>
                    <p className="demo my-5">ABOUT US</p>
                    <p className="demo1">
                        We are a SAAS company with a vision to become a one stop solution
                        for an app publisher that fuels their entire mobile App’s Growth. We
                        help app publishers focus on what they do best – creating great apps
                        – while we enable their business expansion in the app economy.
                    </p>
                </div>
            </div>
            <div className="start">
                ...
                <p style={{fontSize: "20px"}}>
                    To help app developers turn their apps into scalable and successful
                    businesses.
                </p>
            </div>
                ...
                <div className="about">
                    <div className="about1">
                        ...
                        <p className="abouttext1">
                            We believe transparency helps everyone grow while avoiding hassles
                            and making operating easier.
                        </p>
                    </div>
                    ...
                    <div className="about1">
                        ...
                        <p className="abouttext1">
                            We think creatively and then let the data be our guide.
                        </p>
                    </div>
                </div>
                <div className="about">
                    ...
                    <div className="about1">
                        ...
                        <p className="abouttext1">
                            We love taking the initiative to explore new ideas. We’re
                            adaptable, embrace change and learn from failure.
                        </p>
                    </div>
                </div>
            </div>
            <div className="start my-3 container">
                <p>
            ...
            <div
                className="dimoo"
                style={{backgroundColor: "#E2EFFF", marginTop: "80px"}}
            >
                <div>
                    <img className=" demoimg" src={img5} alt="img"></img>
                </div>
                <div>
                    <p className="demo" style={{fontSize: "25px", marginTop: "80px"}}>
            ...
            <div className="dimo">
                <div style={{marginTop: "80px"}}>
                    ...
                    <p className="demo1">
                        ...
                        individuals set to revolutionize the AdTech industry.
                    </p>

                    <p className="demo1">
                        Innovation, creativity, and inspiration are part of our every day —
