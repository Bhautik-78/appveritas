...
export default function Contact() {
  ...
  <div className='dimo'>
        ...
        <div>
            <p className='demo' style={{marginTop:"200px"}}>Let AppBroda help you grow your App Business</p>
     ...
     <div className="form">
        ...
        <div className="input">
          ...
          <div className="input">
            ...
            <br></br>
            <input style={{height:"80px"}} className="input" type="text" id="fname" name="fname" />
          </div>
          <div className='btn' style={{marginTop:"90px"}}> <button className='btn1'>Set Up Demo</button></div>
        </div>
    ...
    <div>
        <p className='demo1' style={{marginTop:"200px"}}>We understand that some queries need immediate responses. We support you with a dedicated account manager and 24×7 chat support on WhatsApp.</p>
