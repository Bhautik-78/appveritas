    ...
    <>
     ...
     <div className='dimo'>
        <div>
            ...
            <p className='demo1'>Scraper – an app store optimization tool by AppBroda to help with mobile app optimization. Use it to identify top trending niches, increase organic installs and stay ahead of the competition!</p>
     ...
     <div className='dche'>
        ...
        <p className='yche1'>✅ Identify top trending niches with high traffic & low competition</p>
        <p className='yche1'>✅ Ride on the trends on Play Store and App Store</p>
        <p className='yche1'>✅ Analyze how your app is discovered and optimize for the best keywords</p>
        <p className='yche1'>✅  Analyze your app reviews for better User Research and feature ideas</p>
       
        <p className='yche1'>✅ Explore the top competitors for your app and track them daily</p>
        <p className='yche1'>✅  One stop solution for ASO, competitor tracking, and market research</p>
        </div>
     </div>
     <div className='ssimg'>
        <div>
            ...
            <p className='sstext3'> Scraper provides you insightful data to leverage your app’s growth with App Store Optimization, competitive analysis and in-depth research. With this appstore intelligence tool, you can analyze the current trends in the app development market, track your competitors, and generate country-wise growth plans.</p>
            <p className='sstext3'> Save $$ with our free App store Optimization tool, while staying ahead of your competitors. No need to hire expensive agencies when you can get the same results for free with our Market intelligence tool.</p>
            <p className='sstext3'> With a unified dashboard and simple to use workflow, you can examine your own app, your competitors’ apps, keywords that drive downloads, discover keywords to improve search campaigns, statistically analyze the performance of competitors’ keywords and identify new prospects, including localization and similar keywords.</p>
        </div>
        
     </div>
     <div className='start'>
      <p>Here Are Some Innovative Features of Our Market Intelligence Tool:</p>
     </div>
...
<div className='hetextt'>
        ...
        <div>
            ...
            <p className='hetext'>Get historical data for any app on Google Play Store or Apple App Store</p>
        </div>
        </div>
        <div className='hetextt'>
        <div>
        ...
        <div>
            ...
            <p className='hetext'>Get country wise, genre wise and collection wise top chart results on a single dashboa</p>
        </div>
        </div>
        <div className='hetextt'>
        <div>
        ...
        <div>
            ...
            <p className='hetext'>Create a watchlist for your app and your competitor’s app to get detailed statistic on average daily, weekly and monthly installs, thier increment, reviews received, app ratings, etc</p>
        </div>
        </div>
     ...
     <div className='ourr'>
        ...
        <div>
            ...
            <p className='otext'>Get free access to the premium features of an ASO tool like keyword discovery, rank tracking, traffic generation, difficulty level of each keyword and so much more</p>
        </div>
        </div>
        <div className='our'>
        <div>
        ...
        <div>
            ...
            <p className='otext'>We aim at building a cohesive tool aligned with your requirements. Get the features you need by posting feature requests in feedback section</p>
        </div>
        </div>
     </div>
     ...
     <div  className='fche'>
        ...
        <p className='ftext'>Actionable insights for your Target Geography  </p>
