    ...
    return (
        <>
            <div className="dimo">
                <div>
                    <p className="demo">
                        Fast-Track your App Growth with our 360° App Monetization Platform.
                    </p>
                    <p className="demo1">
                        Tailor made ad strategies from AdMob experts for your apps.
                    </p>
                    <Link to="/Setup">
                        {" "}
            ...
            <div className="dche">
                <div>
                    ...
                    <p className="yche1">
                        ❌ Unable to find right ad partner for mediationr
                    </p>
                ...
                <div className="color">
                    ...
                    <p className="yche1">
                        ✅Ad Ops support to takes care of your day-to-day operations
                    </p>
                    <p className="yche1">
                        ✅ AdMob experts makes personalised optimization strategy
                    </p>
                    <p className="yche1">
                        ✅ Set up Mediation and Open Bidding to increase Fill Rate and eCPM
                    </p>
                    <p className="yche1">✅ Tailored-Tactics to increase ARPDAU</p>
                    <p className="yche1">
                        ✅ Explore the best app monetization platforms
                    </p>
                    <p className="yche1">
                        ✅A/B test different ad placements to increase user experience and
                        retention
                    </p>
                    <p className="yche1">
                        ✅ Solve policy violations instantly with AdMob experts{" "}
                    </p>
                </div>
            </div>
            <div >
                ...
                <div className="sign">
                    <div className="signn">
                        ...
                        <p className="sign3">
                            Connect & schedule a free consultation with our experts to gather
                    ...
                    <div className="signn">
                        ...
                        <p className="sign3">
                            Our experts audit your app and identify gaps to create a
                            personalised optimization plan and explore new revenue
                            opportunities.
                        </p>
                    </div>
                    <div className="signn">
                        ...
                        <p className="sign3">
                            Make the required changes and start earning more revenue everyday.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="ourr">
                <div className="our">
                    ...
                    <div>
                        ...
                        <p className="otext">
                            Get a dedicated account manager and Ad ops support for all your
                            needs
                        </p>
                    </div>
                </div>
                <div className="our">
                    ...
                    <div>
                        ...
                        <p className="otext">
                            Grow your app’s revenue keeping user experience & retention in
                            mind{" "}
                        </p>
                    </div>
                </div>
                <div className="our">
                    <div>
                        <img className="oimg" src={img4} alt="img"/>
                    </div>
                    <div>
                        <p className="otext1">A/B Testing</p>
                        <p className="otext">
                            We conduct A/B tests to get optimum ad placements for higher
                            revenue
                        </p>
                    </div>
                </div>
                <div className="our">
                    ...
                    <div>
                        ...
                        <p className="otext">
                            We make strategies to increase the average revenue per daily
                            active user by increasing overall eCPM and retention
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="dimo">
                ...
                <div>
                    <p className="gtext">
                        Accelerate Your App Growth with Personalized App Monetization
                        Strategy.
                    </p>
                    <p className="gtext1">Robust App Monetization Strategy</p>
                    <p className="demo1">
                        We help you build strong app monetization strategies based on app
                        metrics and defined goals.
                    </p>
                    <p className="gtext1">Maximize Your ROI</p>
                    <p className="demo1">
                        With Lorem Ipsum, you can leverage Google AdX and multiple app
                        monetization platforms to maximize your ROI.
                    </p>
                    <p className="gtext1">Beat Your Competition</p>
                    <p className="demo1">
                        Publishers can follow the best app monetization trends to stay one
