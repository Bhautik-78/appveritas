  ...
  return (
    <>
      <div className="dimo">
        <div>
          <p className="demo">
            Increasing your App's Ad Revenue couldn't be easier.
          </p>
          <p className="demo1">
            Firebase & Admob is all you need. Our product works on your existing
            setup to give you instant results.
          </p>
          <Link to="/Setup">
            {" "}
            <button className="demobtn" style={{ width: "250px" }}>
              Optimize my Revenue{" "}
            </button>
          </Link>
        </div>
      ...
      <div className="dche">
        ...
        <div className="color">
          ...
          <p className="yche1">
            ✅Complete Ad Ops support to take care of your day-to-day operations
          </p>
          <p className="yche1">
          ...
          <p className="yche1">
            ✅ Optimization experts increase your Ad Revenue with best practices
            and existing trends
          </p>
        </div>
      </div>
      <div className="ssimg">
        <div>
          ...
          <p className="sstext3">
            {" "}
            No need to install heavy SDKs to grow your advertising revenue
            anymore, all you need is a Firebase integration provided by our
            experts and get started within minutes.
          </p>
        </div>
        <div>
          ...
          <p className="sstext3">
            {" "}
            We link AdMob/Google AdX, Firebase and Google Analytics, through
            which our analysts study various app metrics and provide insights on
            optimizing ad revenues.{" "}
          </p>
          <p className="sstext3">
            Our experts run experiments and create revenue optimization
            strategies to make smarter decisions for you to see overall revenue
            growth.
          </p>
        </div>
      </div>
      ...
      <div className="tche">
        <div className="tcolor">
          ...
          <p className="ttext">
            Firebase Remote Config to configure ads and run experiments
          </p>
        </div>
        ...
        <div className="tcolor2">
          ...
          <p className="ttext">
            Google Analytics to evaluate and analyse the data
          </p>
        </div>
      </div>
      <div className="start">
      ...
      <div className="uback">
        ...
        <div className="ucolor1">
          ...
          <p className="utext">
            Create personalised optimization plan to meet your goal
          </p>
        </div>
        <div className="ucolor2">
          <img className="uimg" src={img5} alt="img"></img>
          <p className="utext">
            Google Firebase integration to get granular control over your
            optimization
          </p>
        </div>
      </div>
      ...
      <div className="sign">
        <div className="stg">
          ...
          <p className="sign2">No SDK required</p>
        ...
        <div className="stg1">
          ...
          <p className="sign3">
            Optimization strategies sustained over period long of time
          </p>
        </div>
        <div className="stg2">
          ...
          <p className="sign3">
            Our optimization results are evident from day 1
          </p>
        </div>
      </div>
      <div className="sign">
        ...
        <div className="stg1">
          ...
          <p className="sign3">
            Get quick response to your queries with our WhatsApp Support
          </p>
        </div>
      </div>
      {/* <Slide/> */}
