    ...
    return (
        <>
            <div className="container">
                <div>
                    <h1 className="midel my-3">Success Stories</h1>
                </div>
                <div>
                    <h3 className="midel my-4">Since inception, we have helped our publishers across multiple industry
                        verticals see massive changes, be it the increase in their revenue or their </h3>
                </div>
                <div className="admob my-3">
                    <div>
                        <Link to="/Success">
                    ...
                    <div>
                        <Link to="/Ad">
                            <button className="btn btn-dark">Ad Revenue Optimization</button>
                        </Link>
                    </div>
                    <div>
                        <Link to="/Users">
                            <button className="btn btn-dark">User Growth</button>
                        </Link>
                    </div>
